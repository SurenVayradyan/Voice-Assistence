...
class Assistant:
    ...
    def __init__(self):
        ...
        self.cmds = {
            ('текущее время', 'сейчас времени', 'который час', 'время', 'time', 'тайм'): self.time,
            ('привет', 'добрый день', 'здравствуй', 'доброй утро', 'доброй ночи', 'хай'): self.hello,
            ('пока', 'вырубись', 'отключись', 'выключись'): self.quite,
            ('выключи компьютер', 'выруби компьютер', 'выруби комп'): self.shut,
            ('какая погода', 'погода', 'погода на улице'): self.weather,
            ('закрыть вкладку'): self.closer,
        ...
        self.ndels = ['подъем', 'эй', 'але', 'слышь', 'джигга', 'не могла бы ты', 'пожалуйста',
                      'плиз', 'сейчас']
        ...
        self.commands = [
            ...
            'пока', 'вырубись', 'закрыть вкладку', 'закрой вкладку',
    ...
    def opener(self, task):
        links = {
            ...
            ('twitch', 'твитч'): 'https://www.twitch.tv/',
            ('фильмы', 'кино', 'фильмец'): 'https://anicat.ru/movie',
            ...
            ('почта', 'почту', 'mail', 'мейл', 'меил', 'маил'): 'http://mail.ru/',
        }
        j = 0
        if 'и' in task:
    ...
    def hello(self):
        self.talk(choice(['Привет, чем могу помочь?', 'Здраствуйте', 'Приветствую', 'Приветик', 'Здорова']))
    ...
    def weather(self):
        ...
        owm = OWM('2400a6e2987a8f63d5a9e6c8428f6d37')  # Ваш ключ с сайта open weather map
    ...
    def closer(self):
        ...
        pyautogui.press('w')
        self.talk(choice(['Вкладка закрыта', 'Закрыть Вкладку']))
